...
<location class="location-detail">
    ...
    <!-- <div class="location-images"><img src="{{ asset('/storage/app/public/' .$location->images_path) }}" alt="notFound" width="500"></div> -->
    <div class="location-images"><img src="{{ $imageUrl }}" alt="notFound" width="500"></div>
